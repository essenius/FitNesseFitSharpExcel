...
namespace ExcelFixture
{
    public class ExcelQuery
    {
        ...
        {
            {string.Empty, "Query a range of an excel sheet. Parameters: script fixture, range, useheaders (or empty)"},
            {nameof(Query), "Return the selected data range as a query result"}
        };
